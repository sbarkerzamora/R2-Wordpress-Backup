...
$schedules = array(
	''             => __( 'No automatic backup', 'r2-cloud-backup' ),
	'r2wb_daily'   => __( 'Once daily', 'r2-cloud-backup' ),
	'r2wb_weekly'  => __( 'Once weekly', 'r2-cloud-backup' ),
	'r2wb_monthly' => __( 'Once monthly', 'r2-cloud-backup' ),
);
?>
<div class="wrap r2wb-wrap">
	<h1 class="text-xl font-semibold text-slate-900 mb-3"><?php esc_html_e( 'Schedules', 'r2-cloud-backup' ); ?></h1>
	<p class="r2wb-description"><?php esc_html_e( 'Configure automatic backups to R2.', 'r2-cloud-backup' ); ?></p>
		...
		<form method="post" action="" class="space-y-4">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
				<div class="space-y-2">
					<label for="r2wb_schedule_interval" class="block text-sm font-medium text-slate-700">
						<?php esc_html_e( 'Automatic backup', 'r2-cloud-backup' ); ?>
					</label>
					...
					<p class="text-xs text-slate-500">
						<?php esc_html_e( 'Choose how often a backup should be created and sent to R2.', 'r2-cloud-backup' ); ?>
					</p>
				</div>
				<div class="space-y-2">
					<label class="block text-sm font-medium text-slate-700">
						<?php esc_html_e( 'Next run', 'r2-cloud-backup' ); ?>
					</label>
					<p class="text-sm text-slate-700">
						...
						if ( $next_run ) {
							...
							esc_html_e( 'No backup scheduled.', 'r2-cloud-backup' );
						}
						?>
					</p>
				</div>
			...
			<div>
				<button type="submit" class="button button-primary inline-flex items-center px-4 py-2 rounded-md bg-sky-600 hover:bg-sky-700 text-white text-sm">
					<?php esc_html_e( 'Save schedule', 'r2-cloud-backup' ); ?>
				</button>
			</div>
		</form>
	</div>
