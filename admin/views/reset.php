...
<div class="wrap r2wb-wrap">
	...
	<div class="r2wb-alert r2wb-alert--warning">
		<p class="r2wb-alert__title"><?php esc_html_e( 'Reset configuration', 'r2-wordpress-backup' ); ?></p>
		<p class="r2wb-alert__body"><?php esc_html_e( 'This will reset the plugin configuration and scheduled backups to their defaults. R2 credentials will be kept unless you remove them manually from Settings.', 'r2-wordpress-backup' ); ?></p>
		<p class="r2wb-alert__body text-xs mt-2"><?php esc_html_e( 'Use this only if you want to start over with a clean configuration.', 'r2-wordpress-backup' ); ?></p>
		<p class="mt-4">
